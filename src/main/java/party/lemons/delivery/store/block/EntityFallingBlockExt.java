...
public class EntityFallingBlockExt extends Entity
{
    ...
    private static final DataParameter<Optional<IBlockState>> TILE = EntityDataManager.<Optional<IBlockState>>createKey(EntityEnderman.class, DataSerializers.OPTIONAL_BLOCK_STATE);
