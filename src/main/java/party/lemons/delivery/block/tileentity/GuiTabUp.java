...
public class GuiTabUp extends GuiTab
{
	public GuiTabUp(int id, int xPos, int yPos, String store, String storeID, ItemStack display, GuiStore storeGui)
	{
	...
	public void drawButtonUnder(Minecraft mc, int mouseX, int mouseY , float partialTicks)
	{
		if (this.visible)
		{
			...
			this.drawTexturedModalRect(this.x, drawX - 8, 196, 44, 21, 27);
			...
			mc.getRenderItem().renderItemAndEffectIntoGUI(display, 8, -5);
